...
public abstract class AbstractJedisShadowInterceptor implements InstanceMethodsAroundInterceptor {

    abstract void modifyArgs(Object[] allArguments);
